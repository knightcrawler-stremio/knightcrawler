...
import {IRedisRepository} from "@redis/interfaces/redis_repository";
...
jest.mock('@redis/redis_repository', () => {
    return {
...
describe('MetadataService Tests', () => {
    let metadataService: MetadataService,
        ...
        mockRedisService: IRedisRepository;

    beforeEach(() => {
        mockCacheService = jest.requireMock<ICacheService>('@services/cache_service');
        mockRedisService = jest.requireMock<IRedisRepository>('@redis/redis_repository');
        ...
        container.bind<IRedisRepository>(IocTypes.IRedisRepository).toConstantValue(mockRedisService);
